...
<style>
  * {
  ...
  #contenedor-form {
    width: 300px;
    height: 800px;
    /* Considera usar 'auto' para ajustarlo al contenido */
    padding: 45px;
  }
  ...
  <section id="ingreso">
    <div id="fondo">
      ...
      <div id="contenedor-form" class="registrar">
        <h2>Registrarse</h2>
        <form method="POST" action="1.2.2 Registrarusr.php">
          ...
          <div id="contenedor-input">
            ...
            <input type="text" required
              name="usrname"><!--el required name es el nombre con el que se identifica dentro de la plataforma.-->
            <label for="username">Nombre de usuario</label>
          </div>
          <div id="contenedor-input">
            <span class="icono"><i class="fa-solid fa-phone"></i></span>
            <input type="tel" required name="telefono"
              pattern="[0-9]*"><!--el  pattern="[0-9]* es para validar que sea un numero q no pase de los 9 digitos-->
